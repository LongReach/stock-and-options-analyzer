...
Why should this matter to potential employers? Because this is an example of me doing something I care about, entirely on my own initiative, and with no support from anyone else. While there are other algorithmic (or algorithm-informed) stock and options traders out there that I've learned from, the software in this repository shows what I can do without any other person carrying some part of the load. Other people have answered some of my questions, on Stackoverflow and other such websites, but the roadmap is mine. A lifetime of programming experience and well-honed intuition, going back to when I was nine years old, informs my work here. This isn't a game to me: stock and options trading are a real thing, with real consequences inflicted upon me for getting it wrong. I'm playing with live ammunition and so are the people on the other side of trades. This has to be solid, dependable code.

And I'm not using the "live ammunition" metaphor without appreciation for where it comes from. During my years working in the defense sector, our software supported actual troops fighting actual wars. Once you've seen a few videos of what happens when a munition goes astray or heard a few horror stories from Iraq, you grasp the importance of getting it right. The sloppiness and ineptitude I later saw at companies making software for the civilian market could be very frustrating to me.

I always say in job interviews that documentation is important to me, but the proof of that is in this codebase. Other than a couple parts that are still works in progress, I've written docstrings for nearly every function and have explained my thinking carefully. Because I'm an experienced and skilled writer, I have the ability to communicate my goals, understanding, and reasoning to other software engineers in a clear, articulate way. Which means that I can also do that effectively with AI chatbots.