...
I'm sharing this repository as an example of something I worked during a period that included self-employment, caring for an aging family member, and recovery from a debilitating tendon injury. My life was very challenging in 2025/2026, far more so than any corporate job, but it was still important to me to design and write code, as well as learn how to supercharge my working process by using Claude/Copilot.
