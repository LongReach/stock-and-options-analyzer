...
This is a suite of command line tools for analyzing stock and options market data pulled from [Interactive Brokers](https://www.interactivebrokers.com/).
